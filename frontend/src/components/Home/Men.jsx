...
const Men = () => {
  ...
  return (
    <div className="bg-gray-100 min-h-screen py-14 px-6 md:px-10">
      <h2 className="text-4xl font-extrabold text-center text-gray-800 mb-10">Men's Collection</h2>
      ...
      {isLoading ? (
        ...
        <div className="flex justify-center items-center h-96 w-full">
          <p className="text-xl font-bold text-gray-500">No men's products found.</p>
        </div>
      )}
    </div>
  );
